...
if(NOT mp-units_FOUND)
    # mp-units reads these in its own CMakeLists, so set them BEFORE MakeAvailable:
    set(MP_UNITS_API_CONTRACTS NONE CACHE STRING "" FORCE)   # avoid gsl-lite/ms-gsl transitive dep
